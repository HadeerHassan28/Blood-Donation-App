  ...
  return <>
    <div style={{ fontFamily: "Montserrat Alternates", height: "60vh" }} className="container py-5 d-flex justify-content-center align-items-center">
      <div className="errorContent text-center py-5">
        ...
        <h3 className="mt-4 mb-4 text-muted">{t("Page not found")}</h3>
        <p className="text-danger fs-5">{t("Oops! The page you are looking for does not exist. It might have been removed or deleted")}</p>
      </div>
    </div>
