...
const OrgEdit = ({ TokenData, saveTokenData }) => {
        ...
        if (
            ...
            axios.get("http://localhost:3002/org").then((res) => {
                ...
                const editableUser = users.find((user) => {
                    ...
                    return user.OrgCode === TokenData.OrganizationCode;
                });
                ...
                if (editableUser) {
                    ...
                    axios
                        .patch(`http://localhost:3002/org/${editableUser.id}`, newData)
                        .then((response) => {
                ...
                <form className="row g-3 align-items-center" onSubmit={handleSubmit}>
                    ...
                    <div className="col-lg-12">
                        ...
                        <input
                            ...
                            value={TokenData.OrganizationCode}
                            onChange={handleChange}
                            style={
                                !isOrgCodeFocused
                                    ? {}
                    ...
                    <div className="col-lg-4 mt-5">
                        <select
                            ...
                            required
                        >
                            <option value="sector" hidden>Sector</option>
