  ...
  return (
    <>
      <div className="container py-5 mt-5">
        ...
        <div
          className={`${styles.customFlex} row  align-items-center mt-4`}
          data-aos="fade-right"
        >
          <div className="col-md-4 col-sm-12">
        ...
        <div
          className={`${styles.customFlex} row  align-items-center mt-5`}
          data-aos="zoom-in-up"
        >
          <div className="col-md-4 col-sm-12">
      ...
      <div
        style={{ backgroundColor: "#344258" }}
        className="py-5  mb-5 text-white text-center rounded"
      >
      ...
      <div className="container testimonials py-5 mb-5">
        <div className="text-center">
          ...
          <p className="fs-5 text-muted">
            <Trans i18nKey="Lives Saved Paragraph">
              ...
              >
                <div className="d-flex p-3 justify-content-start align-items-center">
                  <img
                    ...
                    alt=""
                    className={`${styles.customimg} mr-4`}
                  />
                ...
                <div className="card-body">
                  <blockquote>
                    <p className="mb-0">
                      <BsQuote
                        className={`${styles.qout} text-danger`}
                      ></BsQuote>{" "}
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                      Labore, eum minima in cumque cum assumenda accusamus. Qui
                      autem non ipsum!
                    </p>
                  </blockquote>
                </div>
