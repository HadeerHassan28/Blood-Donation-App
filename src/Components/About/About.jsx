      ...
      <div className="container py-5 mt-5">
        ...
        <div className="row gy-2">
          <div className={`${styles.card} col-lg-4 text-center py-5 px-2`}>
            <SiQuantconnect color="#ee394a" size={30}></SiQuantconnect>
            <h5>What we do?</h5>
          ...
          <div className={`${styles.card} col-lg-4 text-center py-5 px-2`}>
            <FaRegLightbulb color="#ee394a" size={30}></FaRegLightbulb>
            <h5>Innovative</h5>
            <p className="text-muted">
          ...
          <div className={`${styles.card} col-lg-4 text-center py-5 px-2`}>
            <BsGlobe2 color="#ee394a" size={30}></BsGlobe2>
          ...
          <div className={`${styles.card} col-lg-4 text-center py-5 px-2`}>
            <FaMoneyCheckAlt color="#ee394a" size={30}></FaMoneyCheckAlt>
          ...
          <div className={`${styles.card} col-lg-4 text-center py-5 px-2`}>
            <AiOutlineHeart color="#ee394a" size={30}></AiOutlineHeart>
            <h5>Save Life</h5>
            <p className="text-muted">
